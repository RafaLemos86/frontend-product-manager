...
export default function Menu() {
    ...
    function setComponents() {
        if (visible === 1) {
            return <ProductRegister text="Product Registration" />
        } else if (visible === 2) {
            return <ProductList text="Product Listing" />
        } else if (visible === 3) {
            return <CategoryRegister text="Category Registration" />
        } else if (visible === 4) {
            return <CategoryList text="Category Listing" />
        }
    }
                ...
                <List>
                    ...
                    <ListItem onClick={() => { setVisible(3) }} key={3} disablePadding>
                        <ListItemButton>
                            ...
                            <ListItemText primary={"Category Registration"} />
                        </ListItemButton>
                    </ListItem>
                    ...
                    <ListItem onClick={() => { setVisible(4) }} key={4} disablePadding>
                        <ListItemButton>
                            ...
                            <ListItemText primary={"Category Listing"} />
                        </ListItemButton>
                    </ListItem>
                </List>
            </Drawer>
